  ...
  return (
    <div className="min-h-screen bg-[#F4F3F6]">
      <header className="bg-white/80 backdrop-blur-xl border-b border-black/10 sticky top-0 z-50 print:hidden">
        <div className={`${isToolsArea ? 'mx-auto max-w-[1200px]' : 'mx-auto max-w-5xl'} flex h-12 items-center justify-between px-6`}>
      ...
      <main className={`${isToolsArea ? 'mx-auto max-w-[1200px]' : 'mx-auto max-w-5xl'} px-6 py-10`}>
        {isToolPage && (
